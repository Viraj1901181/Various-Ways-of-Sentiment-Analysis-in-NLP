# -*- coding: utf-8 -*-
"""PDF_Sentences_Sentiment_Analysis with VADER_Final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wjPjnmmO4BtADwbQNiz_KsjMFw1iat0V
...
open_filename_WS = open("/content/Witness Statement Pack.pdf", 'rb')
open_filename_DB = open("/content/ET unmarked.pdf", 'rb')
open_filename_ET = open("/content/ET unmarked.pdf", 'rb')
...
with open("sentenceWSvader.csv", 'w') as myfile:
    for x in sentenceWS:
        myfile.write(x)
        myfile.write("\n")
...
df = pd.read_csv('sentenceWSvader.csv')
